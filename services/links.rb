  ...
  module Services
    class Links < Modusynth::Services::Base
      ...
      def build from: nil, to: nil, synthesizer_id: nil, color: 'red', session: nil, **_
        ...
        from = Ports.instance.find_or_fail(id: from, field: 'from')
        to = Ports.instance.find_or_fail(id: to, field: 'to')
      ...
      def validate!(from: nil, to: nil, synthesizer_id: nil, color: 'red', session: nil, **_)
        ...
        raise Modusynth::Exceptions::BadRequest.new('directions', 'identical') if instance.from.kind == instance.to.kind
