RSpec.shared_examples 'empty lists' do
  it 'has Created no blueprint' do
...
RSpec.describe Modusynth::Controllers::Blueprints do
  ...
  describe 'POST /' do
    ...
    describe 'Nominal case' do
      ...
      describe 'Created blueprint' do
        let!(:blueprint) { Modusynth::Models::Blueprints::Blueprint.first }

        it 'Has the correct name' do
          expect(blueprint.name).to eq 'VCA'
        end
        it 'has the correct number of slots' do
          expect(blueprint.slots).to be 3
        end
        it 'has no inner nodes' do
          expect(blueprint.inner_nodes).to eq []
        end
        it 'Has no linked parameters' do
          expect(blueprint.parameters).to eq []
        end
      end
    end

    describe 'Alternative cases' do
      describe 'Blueprint with inner nodes' do
        before do
          post '/', {
            name: 'VCA',
            slots: 3,
        ...
        it 'Returns the correct body' do
          creation = Modusynth::Models::Blueprints::Blueprint.first
          expect(last_response.body).to include_json(
            id: creation.id.to_s,
            name: 'VCA',
            slots: 3,
        ...
        describe 'Created inner nodes' do
          ...
          it 'Has created exactly one inner node' do
            expect(blueprint.inner_nodes.size).to be 1
          end
      ...
      describe 'Blueprints with placed inner nodes' do
        before do
          post '/', {
            name: 'VCA',
            slots: 3,
        ...
        describe 'The created node coordinates' do
          let!(:creation) { Modusynth::Models::Blueprints::Blueprint.first.inner_nodes.first }
      ...
      describe 'Blueprint with inner links' do
        before do
          post '/', {
            name: 'VCA',
            slots: 3,
      ...
      describe 'Blueprint with parameters' do
        before do
          post '/', {
            name: 'VCA',
            slots: 3,
      ...
      describe 'Blueprint with inputs' do
        before do
          post '/', {
            name: 'VCA',
            slots: 3,
        ...
        describe 'Created input port' do
          let!(:blueprint) { Modusynth::Models::Blueprints::Blueprint.first }
          let!(:input) { blueprint.inputs.first }

          it 'Has created only one input' do
            expect(blueprint.inputs.size).to be 1
          end
      ...
      describe 'Blueprint with outputs' do
        before do
          post '/', {
            name: 'VCA',
            slots: 3,
        ...
        describe 'Created input port' do
          let!(:blueprint) { Modusynth::Models::Blueprints::Blueprint.first }
          let!(:output) { blueprint.outputs.first }

          it 'Has created only one input' do
            expect(blueprint.outputs.size).to be 1
          end
          it 'Has created a port with the correct name' do
