    ...
    module Blueprints
      ...
      class InnerNode
        ...
        def generator_object
          Modusynth::Models::Blueprints::Generator.find_by(name: generator)
        end
        ...
        embedded_in :blueprint, class_name: '::Modusynth::Models::Blueprints::Blueprint', inverse_of: :inner_nodes
      end
    end
  end
end
